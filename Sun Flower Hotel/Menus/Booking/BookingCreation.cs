        ...
        public void CreateBooking()
        {
              try
                ...
                var checkInDate = SelectDate("Select [yellow]Check-In Date[/]:");
                    ...
                    var employeeId = AnsiConsole.Ask<int>("Enter [yellow]Employee ID[/]:");
                    ...
                    using (var context = new HotelDbContext())
                    {
                        ...
                        // Validate EmployeeId
                        if (!context.Employees.Any(e => e.EmployeeId == employeeId))
                        {
                            AnsiConsole.Markup("[red]Error: Employee does not exist.[/]\n");
                            return;
                        }
