...
namespace Sun_Flower_Hotel.Menus
{
    ...
    {
        private readonly RoomDatabaseHelper dbHelper;
        private readonly InputValidator validator;

        // Constructor to initialize DbHelper and Validator
        public RoomMenu()
        {
         ...
         .Build();
            ...
            dbHelper = new RoomDatabaseHelper(optionsBuilder.Options);
            ...
            try
            {
                ...
                var type = AnsiConsole.Prompt(
                    new SelectionPrompt<string>()
                        ...
                        .AddChoices(new[] { "Single", "Double", "Suite", "Economy", "Deluxe", }));

                // Prompt for additional room details
        ...
        private void SearchAvailableRooms()
        {
            try
            {
                ...
                // Fråga om endast lediga rum ska inkluderas
                var onlyAvailable = AnsiConsole.Confirm("Only show available rooms?");

                // Hämta filtrerade rum från databasen
                ...
                // Skapa tabell för att visa filtrerade rum
                var table = new Table();
                table.AddColumn("[cyan]Room Number[/]");
                table.AddColumn("[cyan]Type[/]");
                table.AddColumn("[cyan]Price[/]");
        ...
        private void EditRoom()
        {
            try
            {
                ...
                // Ask for new Room Type or keep current
                ...
                // Ask for new Room Price or keep current
                ...
                // Ask for new Extra Beds or keep current
                ...
                // Ask for new Max Guests or keep current
